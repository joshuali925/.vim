return {
    ...
    },
    {
        ...
        keys = {
            ...
            { "<C-b>", "<Cmd>lua require('snacks.terminal').toggle()<CR>", mode = { "n", "t" } },
            { "<leader>to", "<Cmd>lua require('snacks.terminal').open(nil, { cwd = vim.fn.expand('%:p:h') })<CR>" },
            { "<leader>tv", "<Cmd>lua require('snacks.terminal').open(nil, { win = { position = 'right' } })<CR>" },
