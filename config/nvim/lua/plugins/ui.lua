    ...
    },
    {
        ...
        config = function()
            ...
            vim.fn["quickui#menu#install"]("&Actions", {
                ...
                { "Ded&up lines", [[lua require("utils").dedup_lines()]], "Remove duplicated lines and preserve order" },
                ...
                { "Diff directories", [[call feedkeys(":CodeDiff dir ", "n")]], "Run DirDiff to compare two directories" },
                { "--", "" },
            ...
            vim.fn["quickui#menu#install"]("&Actions", {
                ...
                { "&Reverse lines", [[lua require("utils").reverse_lines(vim.fn.line("'<"), vim.fn.line("'>"))]], "Reverse the order of selected lines" },
