...
GlobalSpeed.json (maybe try https://github.com/xxxily/h5player)
...
api.mapkey('yoT', 'Use water.css', function() {
    ...
    const linkElm = createElement('link', { rel: 'stylesheet', href: 'https://cdn.jsdelivr.net/npm/water.css@2/out/light.css' })
    document.head.append(linkElm, !document.querySelectorAll('meta[name="viewport"]').length && createElement('meta', {
        name: 'viewport',
    ...
    const toggleTheme = () => {
        ...
        linkElm.href = `https://cdn.jsdelivr.net/npm/water.css@2/out/${theme}.css`
    }
