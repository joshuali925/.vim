...
hi ColorColumn guibg=#2d323b ctermbg=237
hi Conceal guifg=#4b5263 ctermfg=239 guibg=NONE ctermbg=NONE
hi Cursor guibg=#528bff ctermbg=69
hi CursorColumn guibg=#2d323b ctermbg=237
hi CursorLine guibg=#2d323b ctermbg=237 gui=none cterm=none
hi Directory guifg=#61afef ctermfg=75
hi ErrorMsg guifg=#e06c75 ctermfg=2358 guibg=NONE ctermbg=NONE gui=none cterm=none
hi VertSplit guifg=#3e4452 ctermfg=238 gui=none cterm=none
hi Folded guifg=#292c33 ctermfg=235 guibg=#5c6370 ctermbg=241 gui=none cterm=none
hi FoldColumn guifg=#4b5263 ctermfg=239 guibg=#292c33 ctermbg=235
hi IncSearch guifg=#d19a66 ctermfg=173
hi LineNr guifg=#4b5263 ctermfg=239
hi CursorLineNr guifg=#abb2bf ctermfg=249 guibg=#2d323b ctermbg=237 gui=none cterm=none
hi MatchParen guifg=#e06c75 ctermfg=2358 guibg=NONE ctermbg=NONE gui=underline,bold cterm=underline,bold
...
hi Search guifg=#292c33 ctermfg=235 guibg=#e5c07b ctermbg=180
hi SpecialKey guifg=#3e4452 ctermfg=238 gui=none cterm=none
hi StatusLine guifg=#abb2bf ctermfg=249 guibg=#30353f ctermbg=237 gui=none cterm=none
hi StatusLineNC guifg=#292c33 ctermfg=235 guibg=#5c6370 ctermbg=241 gui=none cterm=none
...
hi WarningMsg guifg=#e06c75 ctermfg=2358
hi WildMenu guifg=#abb2bf ctermfg=249 guibg=#5c6370 ctermbg=241
hi SignColumn guibg=#292c33 ctermbg=235
...
hi Identifier guifg=#e06c75 ctermfg=2358 gui=none cterm=none
...
hi Error guifg=#e06c75 ctermfg=2358 guibg=NONE ctermbg=NONE gui=bold cterm=bold
hi Todo guifg=#c678dd ctermfg=176 guibg=NONE ctermbg=NONE gui=italic cterm=italic
hi StatusLineNormal guifg=#30353f ctermfg=237 guibg=#98c379 ctermbg=114 gui=bold cterm=bold
hi StatusLineInsert guifg=#30353f ctermfg=237 guibg=#61afef ctermbg=75 gui=bold cterm=bold
hi StatusLineReplace guifg=#30353f ctermfg=237 guibg=#e06c75 ctermbg=2358 gui=bold cterm=bold
hi StatusLineVisual guifg=#30353f ctermfg=237 guibg=#c678dd ctermbg=176 gui=bold cterm=bold
hi StatusLineCommand guifg=#30353f ctermfg=237 guibg=#56b6c2 ctermbg=73 gui=bold cterm=bold
hi StatusLineBranch guifg=#56b6c2 ctermfg=73 guibg=#30353f ctermbg=237
hi StatusLineHunkAdd guifg=#98c379 ctermfg=114 guibg=#30353f ctermbg=237
hi StatusLineHunkChange guifg=#d19a66 ctermfg=173 guibg=#30353f ctermbg=237
hi StatusLineHunkRemove guifg=#e06c75 ctermfg=2358 guibg=#30353f ctermbg=237
hi StatusLineFileName guifg=#abb2bf ctermfg=249 guibg=#30353f ctermbg=237
hi StatusLineFileModified guifg=#c678dd ctermfg=176 guibg=#30353f ctermbg=237
hi StatusLineFormat guifg=#528bff ctermfg=69 guibg=#30353f ctermbg=237 gui=bold cterm=bold
hi StatusLineError guifg=#be5046 ctermfg=130 guibg=#30353f ctermbg=237
hi StatusLineWarning guifg=#e5c07b ctermfg=180 guibg=#30353f ctermbg=237
...
hi DiffChange guifg=NONE ctermfg=NONE guibg=#30353f ctermbg=237 gui=none cterm=none
