" https://raw.githubusercontent.com/chaoren/vim-wordmotion/5dd613ed68a0ecf0fc6c11cd4098c03583786bf0/autoload/wordmotion.vim

function plugins#wordmotion#init()
	let l:_ = {}
...
call plugins#wordmotion#init()

function plugins#wordmotion#motion(count, mode, flags, uppercase, extra, ...)
	let l:cpo = &cpoptions
	set cpoptions+=c
...
function plugins#wordmotion#object(count, mode, inner, uppercase)
	let l:cpo = &cpoptions
	set cpoptions+=c
	...
	if !l:existing_selection
		call plugins#wordmotion#motion(1, 'n', 'bc', a:uppercase, l:extra, a:mode)
		let l:start = getpos('.')
		normal! v
		call plugins#wordmotion#motion(1, 'n', 'ec', a:uppercase, l:extra, a:mode)
		let l:count -= 1
	endif

	call plugins#wordmotion#motion(l:count, 'n', l:flags, a:uppercase, l:extra, a:mode)
...
function plugins#wordmotion#current(uppercase)
	let l:cursor = getpos('.')
	call plugins#wordmotion#motion(1, 'n', 'ec', a:uppercase, [], 'c')
	let l:end = getpos('.')
	call plugins#wordmotion#motion(1, 'n', 'bc', a:uppercase, [], 'c')
	let l:start = getpos('.')
...
function plugins#wordmotion#reload()
	unlet g:loaded_wordmotion
	runtime plugin/wordmotion.vim
endfunction

function plugins#wordmotion#_default()
	...
	call plugins#wordmotion#reload()
endfunction
