" https://raw.githubusercontent.com/b4winckler/vim-angry/77cdc8c6dc056b62e9f8c75e6eaa5cb52f9cd3a4/plugin/angry.vim
...
"
function! plugins#angry#list(sep, prefix, outer, times, ...)
  let lbracket = '[[({]'
  let rbracket = '[])}]'
