" https://raw.githubusercontent.com/tpope/vim-abolish/dcbfe065297d31823561ba787f51056c147aa682/plugin/abolish.vim
...
function! plugins#abolish#coerce(motion) abort
  return <SID>coerce(nr2char(getchar())) . a:motion
endfunction
